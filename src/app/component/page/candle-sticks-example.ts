...
@Component({
  selector: 'app-chart-example-page-component',
  template: `
    <div appNvD3 [options]="options" [data]="data"></div>
  `,
  styles: []
})
export class CandleSticksExamplePageComponent {
  options = {};
  data = [];
      ...
      chart: {
        ...
        xAxis: {
          ...
          tickFormat: function(d) {
            return 'a';// d3.format('%x')(new Date(Date.now().valueOf() - (20000 * 86400000) + (d * 86400000)));
          },
          showMaxMin: false
        },
